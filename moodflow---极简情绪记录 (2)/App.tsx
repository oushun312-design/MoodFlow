...
const App: React.FC = () => {
  ...
  // 使用持久化存储替代普通 useState
  const [history, setHistory] = useLocalStorage<MoodEntry[]>('mood_history', INITIAL_HISTORY);
  const [futureLetters, setFutureLetters] = useLocalStorage<FutureLetter[]>('future_letters', []);
  ...
  }, [content, selectedMood, setHistory]);
